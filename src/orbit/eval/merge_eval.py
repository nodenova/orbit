...
from orbit.eval.worktree import extract_diff as extract_diff  # noqa: PLC0414
from orbit.eval.worktree import touched_files as touched_files  # noqa: PLC0414
...
def compare_arms(baseline: ArmSummary, candidate: ArmSummary) -> dict[str, Any]:
    ...
    return {
        ...
        "note": (
            ...
            "(orbit.toml [eval]) before treating this as the M3 gate."
            if measured < 3
